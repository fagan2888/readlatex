...
\let\readlatex@endfigure@old\endfigure
\let\endfigure\@undefined

\NewEnviron{figure}[1][htbp]{%
    {
        \let\caption\relax
        \let\ref\relax
    ...
    \readlatex@figure@old[#1]
        \BODY
    \readlatex@endfigure@old
}
...
\newcommand{\reusefigure}[2][htbp]{%
    {
        ...
        \readlatex@figure@old[#1] \csname sf:#2\endcsname \readlatex@endfigure@old
    }
}
