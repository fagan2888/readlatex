...
\RenewEnviron{figure}[1][htbp]{%
    ...
    \def\readlatex@thefigure{
        \begin{readlatex@figure@old}[#1]
            \BODY
        \end{readlatex@figure@old}
    }
    \readlatex@thefigure
    \global\expandafter\let\csname\sfname:height\endcsname\heightof{\readlatex@thefigure}
}
...
\AtBeginDocument{
    ...
    \renewcommand*{\ref}[1]{
        ...
        \addtostream{read@latex}{\csuse{readlatex@savedfigcontent:##1:height}}
    }
}
\makeatother
